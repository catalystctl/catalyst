...
export const defaultThemeColors: ThemeColors = {
  ...
  dangerColor: '#ff5a5a',
  infoColor: '#6fa8ff',
  darkBackground: '#0e1116',
  darkForeground: '#e9edf2',
  darkCard: '#161a21',
  darkSurface1: '#1d222b',
  darkSurface2: '#232a35',
  darkSurface3: '#2b3442',
  darkBorder: '#2b323d',
  darkMuted: '#939dac',
  darkMutedBackground: '#1d222b',
  darkPopover: '#161a21',
  darkInput: '#2b323d',
  lightBackground: '#f0f3f7',
  lightForeground: '#161c24',
  lightCard: '#fcfdff',
  lightSurface1: '#fcfdff',
  lightSurface2: '#e9edf3',
  lightSurface3: '#d5dae2',
  lightBorder: '#d5dae2',
  lightMuted: '#5f6a78',
  lightMutedBackground: '#e9edf3',
  lightPopover: '#fcfdff',
  lightInput: '#d5dae2',
  ringColor: '#ff3d7f',
