...
import { showsDemoChrome } from './isDemo';
...
export default function DemoBanner() {
  ...
  if (!showsDemoChrome) return null;
  return (
    <div
      role="status"
      title={t('demo.banner')}
      className="fixed inset-x-0 top-0 z-40 flex h-8 items-center justify-center gap-2 border-b border-primary/30 bg-card px-3 font-mono text-mini text-foreground/80"
    >
