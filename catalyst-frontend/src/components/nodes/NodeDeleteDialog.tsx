  ...
  return (
    <>
      {controlledOpen === undefined && (
        <button
          className="w-full rounded-md bg-destructive px-3 py-1 text-xs font-semibold text-destructive-foreground shadow-lg shadow-destructive/20 transition-all hover:bg-destructive/90"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/60 px-4 backdrop-blur-sm">
          <div className="w-full max-w-sm rounded-xl border border-border/40 bg-card p-6 shadow-xl">
            ...
            <div className="mt-4 flex justify-end gap-2 text-xs">
              ...
              <button
                className="rounded-md bg-destructive px-4 py-2 font-semibold text-destructive-foreground shadow-lg shadow-destructive/20 transition-all hover:bg-destructive/90 disabled:opacity-60"
