        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/60 px-4">
          <div className="w-full max-w-md rounded-xl border border-border bg-card p-6 shadow-xl">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-semibold text-foreground">Update server</h2>
              <button
            ...
            <div className="mt-4 space-y-3 text-sm text-foreground">
              ...
              <label className="block space-y-1">
                <span className="text-muted-foreground">Disk (MB)</span>
                <input
                  className="w-full rounded-lg border border-border bg-card px-3 py-2 text-foreground transition-all duration-300 focus:border-primary focus:outline-none dark:border-border dark:text-foreground "
                  value={disk}
              ...
              <label className="block space-y-1">
                <span className="text-muted-foreground">Database allocation</span>
                <input
                  className="w-full rounded-lg border border-border bg-card px-3 py-2 text-foreground transition-all duration-300 focus:border-primary focus:outline-none dark:border-border dark:text-foreground "
              ...
              {isIpamNetwork ? (
                <div className="space-y-2">
                  ...
                  <label className="block space-y-1">
                    <span className="text-muted-foreground">Primary IP allocation</span>
                    <select
                      className="w-full rounded-lg border border-border bg-card px-3 py-2 text-foreground transition-all duration-300 focus:border-primary focus:outline-none dark:border-border dark:text-foreground "
                      value={primaryIp}
                ...
                <div className="space-y-2">
                  ...
                  <label className="block space-y-1">
                    <span className="text-muted-foreground">Primary allocation</span>
                    <select
                      className="w-full rounded-lg border border-border bg-card px-3 py-2 text-foreground transition-all duration-300 focus:border-primary focus:outline-none dark:border-border dark:text-foreground "
                      value={allocationId}
