...
export default function ServerConfigurationTab({
 ...
 <button
 type="button"
 className="shrink-0 rounded-md bg-primary px-4 py-2 text-xs font-semibold text-primary-foreground transition-all hover:bg-primary/90 disabled:opacity-50"
