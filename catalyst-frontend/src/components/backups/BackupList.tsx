    ...
    <div className="space-y-3">
      {sorted.map((backup) => {
        ...
        return (
          <div
            key={backup.id}
            className="rounded-xl border border-border dark:border-border bg-white dark:bg-zinc-950/60 px-4 py-4"
          >
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                <div className="flex items-center gap-2">
                  <div className="text-sm font-semibold text-foreground dark:text-zinc-100">{backup.name}</div>
              ...
              <div className="flex flex-wrap items-center gap-2 text-xs">
                {backup.download ? (
                  <button
                    className="rounded-md border border-border dark:border-border px-3 py-1 text-xs font-semibold text-muted-foreground dark:text-zinc-200 hover:border-border dark:border-border disabled:opacity-60"
            ...
            <div className="mt-3 grid grid-cols-2 gap-2 text-xs text-muted-foreground dark:text-zinc-300 sm:grid-cols-5">
              <div className="rounded-md border border-border dark:border-border bg-white dark:bg-surface-1 px-3 py-2">
                <div className="text-muted-foreground dark:text-muted-foreground">Size</div>
                <div className="text-sm font-semibold text-foreground dark:text-zinc-100">
                  {formatBackupSize(toNumber(backup.sizeMb))}
                </div>
              </div>
              <div className="rounded-md border border-border dark:border-border bg-white dark:bg-surface-1 px-3 py-2">
                <div className="text-muted-foreground dark:text-muted-foreground">Storage</div>
                <div className="text-sm font-semibold text-foreground dark:text-zinc-100">
                  {backup.storageMode ?? 'local'}
                </div>
              </div>
              <div className="rounded-md border border-border dark:border-border bg-white dark:bg-surface-1 px-3 py-2">
                <div className="text-muted-foreground dark:text-muted-foreground">Compressed</div>
                <div className="text-sm font-semibold text-foreground dark:text-zinc-100">
                  {backup.compressed === false ? 'No' : 'Yes'}
                </div>
              </div>
              <div className="rounded-md border border-border dark:border-border bg-white dark:bg-surface-1 px-3 py-2">
                <div className="text-muted-foreground dark:text-muted-foreground">Checksum</div>
                <div className="text-[11px] text-muted-foreground dark:text-zinc-200">
                  {backup.checksum ? `${backup.checksum.slice(0, 12)}...` : 'n/a'}
                </div>
              </div>
              <div className="rounded-md border border-border dark:border-border bg-white dark:bg-surface-1 px-3 py-2">
                <div className="text-muted-foreground dark:text-muted-foreground">Path</div>
                <div className="text-[11px] text-muted-foreground dark:text-zinc-200 truncate">{backup.path}</div>
              </div>
            </div>
          </div>
        );
