        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/60 px-4">
          <div className="w-full max-w-sm rounded-xl border border-border/40 bg-card p-6 shadow-xl">
            ...
            <div className="mt-4 flex justify-end gap-2 text-xs">
              ...
              <button
                className="rounded-md bg-primary px-4 py-2 font-semibold text-primary-foreground shadow-[0_0_6px_-1px_hsl(var(--primary)/0.2)] transition-all duration-200 hover:bg-primary/90 disabled:opacity-50"
