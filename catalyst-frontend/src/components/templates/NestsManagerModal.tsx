  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex justify-end gap-2 pt-1">
        <button
          className="rounded-full border border-border px-4 py-1.5 text-xs font-semibold text-muted-foreground transition-all duration-300 hover:border-primary hover:text-foreground dark:border-border dark:text-foreground dark:hover:border-primary/30"
          onClick={onCancel}
        >
          Cancel
        </button>
            ...
            <div className="flex items-center justify-between border-b border-border px-6 py-4 dark:border-border">
              <div className="flex items-center gap-3">
                <div className="relative">
                  ...
                  <FolderOpen className="relative h-5 w-5 text-warning dark:text-warning" />
                </div>
                <div>
