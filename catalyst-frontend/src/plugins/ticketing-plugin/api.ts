...
export async function fetchTicket(id: string): Promise<Ticket> {
  ...
  if (!res.success || !res.data) throw new Error(res.error ?? 'Failed to fetch ticket');
  return res.data;
}
...
export async function updateTicket(id: string, data: UpdateTicketPayload): Promise<Ticket> {
  ...
  if (!res.success || !res.data) throw new Error(res.error ?? 'Failed to update ticket');
  return res.data;
}
...
export async function fetchComments(ticketId: string): Promise<TicketComment[]> {
  ...
  if (!res.success || !res.data) throw new Error(res.error ?? 'Failed to fetch comments');
  return res.data;
}
...
export async function editComment(ticketId: string, commentId: string, content: string): Promise<TicketComment> {
  ...
  if (!res.success || !res.data) throw new Error(res.error ?? 'Failed to edit comment');
  return res.data;
}
...
export async function executeBulkAction(data: BulkActionPayload): Promise<void> {
  ...
  if (!res.success) throw new Error(res.error ?? 'Failed to execute bulk action');
}
...
export async function fetchTags(): Promise<Tag[]> {
  ...
  if (!res.success || !res.data) throw new Error(res.error ?? 'Failed to fetch tags');
  return res.data;
}
...
export async function updateTag(id: string, data: { name?: string; color?: string }): Promise<Tag> {
  ...
  if (!res.success || !res.data) throw new Error(res.error ?? 'Failed to update tag');
  return res.data;
}
...
export async function createTemplate(data: Omit<TicketTemplate, 'id' | 'createdAt'>): Promise<TicketTemplate> {
  ...
  if (!res.success || !res.data) throw new Error(res.error ?? 'Failed to create template');
  return res.data;
}
...
export async function updateTemplate(id: string, data: Partial<Omit<TicketTemplate, 'id' | 'createdAt'>>): Promise<TicketTemplate> {
  ...
  if (!res.success || !res.data) throw new Error(res.error ?? 'Failed to update template');
  return res.data;
}
...
export async function fetchSettings(): Promise<TicketingSettings> {
  ...
  if (!res.success || !res.data) throw new Error(res.error ?? 'Failed to fetch settings');
  return res.data;
}
...
export async function fetchServers(): Promise<ServerRef[]> {
  ...
  if (!res.success || !res.data) throw new Error(res.error ?? 'Failed to fetch servers');
  return res.data;
}
